...
#ifdef __linux__
FX_ENTRY FxBool FX_CALL grSstWinOpen(Display *dpy, Window win,
...
#ifdef DIAG_BUILD
FX_ENTRY void FX_CALL grSplashCb(float x, float y, float width, float height,
                                 FxU32 frame, void (*fn)(int));
#endif
